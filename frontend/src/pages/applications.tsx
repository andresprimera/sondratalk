...
import { fetchUsersApi } from "@/lib/users"
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-muted-foreground">
            {t("Onboarding answers from applicants.")}
          </p>
        </div>
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-12">
          ...
          <p className="text-muted-foreground">
            {t(error.message) || t("Failed to load applications.")}
          </p>
                ...
                <TableRow key={u.id}>
                  ...
                  <TableCell className="max-w-sm">
                    {u.applicationText ? (
                      ...
                      <Badge variant="secondary">{t("No answer")}</Badge>
                    )}
                  </TableCell>
                </TableRow>
              ))
        ...
        <div className="flex items-center justify-between px-4">
          ...
          <div className="flex w-full items-center gap-8 lg:w-fit">
            <div className="hidden items-center gap-2 lg:flex">
              <Label htmlFor="apps-rows-per-page" className="text-sm font-medium">
                {t("Rows per page")}
              </Label>
              <Select
              ...
              >
                <SelectTrigger size="sm" className="w-20" id="apps-rows-per-page">
